...
- **[ROADMAP.md](ROADMAP.md)** — Completed milestones, project status, and future feature plans.
- **[Architecture Guide](docs/architecture.md)** — Detailed technical design and module breakdown.
